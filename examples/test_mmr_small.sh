...
mkfifo example_file_small.ID_sorted.mmr.sam
samtools view example_file_small.ID_sorted.mmr.bam > example_file_small.ID_sorted.mmr.sam &
md5sum -c --quiet ${outfile}.md5 && echo -e "\nTest successfully passed" || echo -e "\nTest failed"
rm example_file_small.ID_sorted.mmr.sam
