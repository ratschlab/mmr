...
print('-dpdf','-S1200,600', sprintf('%s/transcript_correlation_pearson_PM.pdf', experiment));
...
print('-dpdf', '-S1200,600', sprintf('%s/transcript_correlation_spearman_PM.pdf', experiment));
